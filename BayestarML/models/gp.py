...
def sparse_fully_heteroscedastic_gp(
    ...
    with pm.Model() as model:
        ...
        log_ls = pm.Normal("log_ls", mu=-1.2, sigma=0.3, shape=D)
        ...
        log_ls_v = pm.Normal("log_ls_v", mu=-1.2, sigma=0.3, shape=D_var)
        ...
        log_eta_v = pm.Normal("log_eta_v", mu=-0.7, sigma=0.4)

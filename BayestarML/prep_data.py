...
def prep_data(filename:str,
    ...
    normalised_train_data.to_csv("data/"+dataset_key+"_norm_train.txt")
    normalised_test_data.to_csv("data/"+dataset_key+"_norm_test.txt")
    ...
    if XGBoost:
        for t in targets:
            print("\nStarting XGBoost benchmark on "+dataset_key+", target: "+t+"\n")

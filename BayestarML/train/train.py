...
if __name__ == "__main__":
    ...
    print("693ms R NN, 8_2000, NUTPIE, priors are 0.04/0.12 He weight, 0.1/0.25 bias and exp lam=1 on omega. mu_X with sigma=0.2. Using pm.MvNormal. -1.2, 0.3 log_er")
    train_NN_1layer(

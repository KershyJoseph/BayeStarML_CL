...
df_low_d_4 = df_low_d_3[df_low_d_3["FeH"].notna()]
df_low_d_MH = df_low_d_3[(df_low_d_3["FeH"].isna()) & (df_low_d_3["MH"].notna())]
print(f"Of which {len(df_low_d_4)} have FeH and {len(df_low_d_MH)} don't have FeH but have MH.")
...
TLF = ["eTeff1", "eTeff2", "elogg1", "elogg2", "eFeH1", "eFeH2"]
all6 = [*MRL, *TLF]
df_no_nas = df_low_d_6_Lerr.dropna(subset=all6)
